...
public class BootFinishListener implements ApplicationListener<ApplicationEvent> {
    ...
    private static HashMap<CompanyTag, SmsCompany> companyHashMap = new HashMap<>();
            ...
            synchronized (BootFinishListener.class) {
                ...
                for (String key : beansOfType.keySet()) {
                    ...
                    if (!companyList.contains(tag)) {
                        companyList.add(tag);
                        companyHashMap.put(tag, smsService);
                    } else {
                        logger.info("#############################################################");
    ...
    public SmsCompany getSmsCompanyByTag(CompanyTag tag) {
